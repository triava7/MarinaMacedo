  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-dark': 'linear-gradient(180deg, hsl(var(--background)), hsl(var(--charcoal-dark)))',
      ...
      boxShadow: {
        'gold': '0 4px 30px rgba(201, 169, 98, 0.2)',
        'gold-lg': '0 10px 50px rgba(201, 169, 98, 0.3)',
        'elegant': '0 20px 50px rgba(0, 0, 0, 0.4)',
